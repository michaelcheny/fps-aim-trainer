...
},{"../CONSTANTS":"src/CONSTANTS.js","./MenuScene":"src/scenes/MenuScene.js"}],"src/scenes/GameScene.js":[function(require,module,exports) {
"use strict";
...
var GameScene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(GameScene, [{
    ...
    key: "create",
    value: function create() {
      this.startGameText = this.add.text(this.game.renderer.width / 2, this.game.renderer.height * 0.55, ['TEST']).setDepth(11).setFontSize(20).setColor('#00ff22').setInteractive();
      this.startGameText.on('pointerup', function () {
        this.scene.launch(_CONSTANTS.CONSTANTS.SCENES.PLAYING); // this.startGameText.destroy();
        // this.startGameText.visible = false;
      }, this);
    }
  }]);
...
},{}]},{},["../../../.nvm/versions/node/v14.3.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.js"], null)
